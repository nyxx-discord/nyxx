...
abstract class HttpRequest {
  ...
  /// The query parameters for this request that have more than one value.
  final Map<String, List<String>> arrayQueryParameters;
  ...
  HttpRequest(
    ...
    this.arrayQueryParameters = const {},
    this.headers = const {},
    this.auditLogReason,
  ...
  Uri _getUri(Nyxx client) => Uri.https(
        ...
        queryParameters.isNotEmpty || arrayQueryParameters.isNotEmpty ? {...queryParameters, ...arrayQueryParameters} : null,
      );

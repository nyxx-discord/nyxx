...
class Command extends Module {
  ...
  const Command({String name, List<String> aliases = const [], this.main = true}) : super(name, aliases: aliases);
}
...
class Restrict {
  ...
  /// If command is hidden it won't be included in help strings
  final bool hidden;
...
/// Help annotation allows to provide help command for commands. 
/// Help string will be auto generated by framework.
class Help {
  /// Description of command.
  final String description;

  /// Example usage of command. Prefix is prepended.
  final String usage;

  const Help(this.description, {this.usage});
}

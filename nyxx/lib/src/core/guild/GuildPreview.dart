...
class GuildPreview extends SnowflakeEntity {
  ...
  String? iconURL({String format = 'webp', int size = 128}) {
    if (this.iconHash != null)
      return 'https://cdn.${Constants.cdnHost}/icons/${this.id}/${this.iconHash}.$format?size=$size';
  ...
  String? splashURL({String format = 'webp', int size = 128}) {
    if (this.splashHash != null)
      return 'https://cdn.${Constants.cdnHost}/splashes/${this.id}/${this.splashHash}.$format?size=$size';
  ...
  String? discoveryURL({String format = 'webp', int size = 128}) {
    if (this.discoveryHash != null)
      return 'https://cdn.${Constants.cdnHost}/discovery-splashes/${this.id}/${this.discoveryHash}.$format?size=$size';

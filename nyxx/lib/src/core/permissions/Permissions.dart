...
class Permissions implements Convertable<PermissionsBuilder> {
  ...
  void _construct(int permissions) {
    ...
    this.useSlashCommands = PermissionsUtils.isApplied(permissions, PermissionsConstants.useSlashCommands);
    this.requestToSpeak = PermissionsUtils.isApplied(permissions, PermissionsConstants.useSlashCommands);
  }

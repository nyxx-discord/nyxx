...
void main() {
  ...
  bot.onReady.listen((e) async {
    ...
    final msg1 = await channel.sendMessage(MessageBuilder.content("test>test1"));
    msg1.delete(); // ignore: unawaited_futures

    final msg2 = await channel.sendMessage(MessageBuilder.content("test>test2 arg1"));
    msg2.delete(); // ignore: unawaited_futures

    final msg3 = await channel.sendMessage(MessageBuilder.content("test>test3"));
    msg3.delete(); // ignore: unawaited_futures

    final msg4 = await channel.sendMessage(MessageBuilder.content("test>test4"));
    msg4.delete(); // ignore: unawaited_futures

    final msg5 = await channel.sendMessage(MessageBuilder.content("test>test4 test5"));
  ...
  Commander(bot, prefix: "test>", beforeCommandHandler: (context) async {
    if (context.message.content.endsWith("test3")) {
      await context.channel.sendMessage(MessageBuilder.content("Test 10"));
      return true;
    }
